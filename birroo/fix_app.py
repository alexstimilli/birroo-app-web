...
new_footer_content = """      {/* Footer Links */}
      <div className="flex flex-col gap-2 px-2 mt-4 text-center pb-24">
        <Dialog>
          ...
          <DialogContent className="sm:max-w-md rounded-3xl p-6 z-[4000]">
            ...
            <div className="flex flex-col gap-3 mt-2">
              ...
              <div className="flex items-center justify-center w-full h-12 text-sm font-bold rounded-xl bg-slate-100 text-slate-700 select-all">
                Oppure scrivici a: info@birroo.it
              </div>
            </div>
          </DialogContent>
        </Dialog>
